...
// Adding defines for LIS2DU12
#define LIS2DU12_ACC_ODR 120.0f /* ODR = 120Hz , MAX 800Hz*/
#define LIS2DU12_ACC_FS 4 /* FS = 4g , Max 16g */
...
int main(void)
{
  ...
  //BSP_ENV_SENSOR_Init(LPS22DF_0, ENV_PRESSURE | ENV_TEMPERATURE);
...
static void InitMemsSensors(void)
{
  ...
  /*second linear 3-axis accelerometer LIS2DU12*/
  if(BSP_MOTION_SENSOR_Init(LIS2DU12_0, MOTION_ACCELERO)==BSP_ERROR_NONE) {
    if(BSP_MOTION_SENSOR_SetOutputDataRate(LIS2DU12_0, MOTION_ACCELERO, LIS2DU12_ACC_ODR)==BSP_ERROR_NONE) {
      if(BSP_MOTION_SENSOR_SetFullScale(LIS2DU12_0, MOTION_ACCELERO, LIS2DU12_ACC_FS)==BSP_ERROR_NONE) {
        printf("LIS2DU12_0 OK\r\n");
      } else {
    	  printf("Error: LIS2DU12_0 Set_FS_ERR\r\n");
      }
    }else {
    	printf("Error: LIS2DU12_0 Set_ODR_ERR\r\n");
    }
  } else {
	  printf("Error: LIS2DU12_0 Init_ERR\r\n");
  }
